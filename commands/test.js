...
mp.events.add("client_farm_job_start", (o) => {
    ;(localPlayerFarmingSkillLevel = o),
        ...
        tempBlips.push(
            mp.blips.new(285, new mp.Vector3(2234.61, 5066.47, 60), {
                color: 0,
                dimension: 0,
                shortRange: !1,
                scale: 1,
        ...
        tempBlips.push(
            mp.blips.new(285, new mp.Vector3(2146.215, 5181.02, 60), {
                color: 0,
                dimension: 0,
                shortRange: !1,
                scale: 1,
        ...
        tempBlips.push(
            mp.blips.new(141, new mp.Vector3(2232.57, 4903.47, 40.07), {
                color: 0,
                dimension: 0,
                shortRange: !1,
                scale: 1,
        ...
        tempBlips.push(
            mp.blips.new(677, new mp.Vector3(2355.71, 4944.28, 41.59), {
                color: 0,
                dimension: 0,
                shortRange: !1,
                scale: 1,
        ...
        tempBlips.push(
            mp.blips.new(677, new mp.Vector3(2136.07, 4834.98, 40.33), {
                color: 0,
                dimension: 0,
                shortRange: !1,
                scale: 1,
    ...
    (() => {
                ...
                if (r) {
                    ...
                    for (const e of t.split("%")) {
                        ...
                        r.onChangeStatus(-1, t, n.status, i),
                            (n.status = i),
                            (n.isClear = s.getClearStatusFromServer(
                                parseInt(e.slice(-1)),
                            )),
                            (n.lastUpdate = o)
                    }
        ...
        const c = [
            ...
            d = new (class extends s {
                        ...
                        (this.nodePickupInterval = setInterval(() => {
                            ...
                            if (
                                ...
                                if (!this.nodePickupLoad) {
                                    ...
                                    ;(this.nodePickupLoad = !0),
                                        (this.isPlayerInZone = !0)
                                }
                            } else if (this.nodePickupLoad) {
                                for (const o of this.nodes)
                                    o.pickup &&
                                        (o.pickup.destroy(), (o.pickup = null))
                                ;(this.nodePickupLoad = !1),
                                    (this.isPlayerInZone = !1)
                            }
                        }, 450)),
                ...
                startGrowNode(o) {
                    ...
                    null !== this.tempInterval &&
                        clearInterval(this.tempInterval),
                        (this.tempInterval = setInterval(
                            () =>
                                this.isStartGrow
                                    ? 25 <
                                      dist2(localPlayer.position, o.position)
                                        ? ((this.isStartGrow = !1),
                                          this.destroyTempObjects(),
                                          clearInterval(this.tempInterval),
                ...
                startTakeNode(e) {
                    ...
                    for (let o = 0; o < a.length; o++) {
                        const t = a[o],
                            r = mp.objects.new(
                                mp.game.joaat("gta5rp_cabbage_one"),
                                t,
                                {
                                    dimension: 0,
                                    rotation: e.rotation,
                                ...
                                () =>
                                    isLocalPlayerFree()
                                        ? global.handItemIsInHand(
                                            ...
                                            ? void this.requestNodeSubAction(
                                                  e.index,
                                                  "take" + o,
                                              )
                                            : mp.api.notify.error(
                    ...
                    null !== this.tempInterval &&
                        ...
                        (this.tempInterval = setInterval(
                            () =>
                                this.isStartTake
                                    ? 25 <
                                      dist2(localPlayer.position, e.position)
                                        ? ((this.isStartTake = !1),
                                          this.destroyTempObjects(),
                                          clearInterval(this.tempInterval),
                                          void (this.tempInterval = null))
        ...
        const y = () => {
            ...
            const A = localPlayer.vehicle.model
            if (y && A === b) {
                let e = []
                for (const o of y.nodes)
                    o.isClear ||
                    ...
                    for (const o of n) {
                        ...
                        for (const e of o.nodes)
                            e.localEnableBoost &&
                                ...
                                i.push([
                                    e,
                                    dist2(e.position, localPlayer.position),
                                ]))
                        0 == t &&
                            (mp.events.callRemote(
                                "server_farm_field_boost",
                                o.uId,
                            ),
                            (o.localBoostSend = !0))
                    }
                    ...
                    for (const n of i.sort((o, t) => o[1] - t[1])) {
                        ...
                        if (
                            (mp.game.graphics.drawMarker(
                                ...
                                0,
                                0,
                                (180 * r(c - i.position.y, s - i.position.x)) /
                                    e +
                                    90,
                                5,
                                5,
                            ...
                            if (
                                ...
                                ;(o.__timeToDeleteEffect = 15),
                                    ...
                                    (async () => {
                                        ...
                                        return mp.vehicles.exists(o) &&
                                            0 !== o.handle
                                            ? void (mp.game.graphics.setPtfxAssetNextCall(
                                                  "core",
                                              ),
                                              t.push(
                                            ...
                                            : void mp.game.streaming.removeNamedPtfxAsset(
                                                  "core",
                                              )
                                    })()
                            }
    ...
    (() => {
        ...
        const p = [
            ...
            V = p.map((o, t) => {
                ...
                return (
                    (e.ped.pedStreamInHandler = async () => {
                        if (
                            ...
                            if (!mp.peds.exists(e.ped) || 0 === e.ped.handle)
                                return
                        }
                        e.ped.taskPlayAnim(
                            "creatures@cow@amb@world_cow_grazing@base",
        ...
        global.handItemEventOnSet("farmMilBucket", () => {
            ...
            mp.events.add("client_farm_anim_milk_end", (e, r, c) => {
                ...
                if (
                    m &&
                    ((m.lastPlayer = null),
                    mp.objects.exists(m.object) && m.object.destroy(),
                    "farmMilBucket" === p.getVariable("cSen") &&
                        (mp.attachmentMngr.removeFor(
                            p,
                            mp.game.joaat("farmMilBucketItem"),
                        ),
                    ...
                    c ||
                        (async () => {
                            ...
                            return mp.peds.exists(m.ped) && 0 !== m.ped.handle
                                ? (m.ped.taskPlayAnim(
                                      "creatures@cow@move",
                                      "idle_sit_ent",
                                      8,
                                  ...
                                  !mp.peds.exists(m.ped) || 0 === m.ped.handle)
                                    ? (m.isAngry = !1)
                                    : (m.ped.taskPlayAnim(
                                          "creatures@cow@move",
                                          "idle_sit",
                    ...
                    if (
                        (global.disableChatAndKeys(!1),
                        (global.enableCameraOnDisabled = !1),
                        !c || "farmMilBucket" !== p.getVariable("cSen"))
                    )
                        return
                    ;(d = !0),
                        l(!1),
        ...
        const V = () => {
            ...
            l = (o) => {
                d.forEach((o) => mp.blips.exists(o) && o.destroy()),
                    "tree" === o
                        ? (d = r.map((o) =>
                              mp.blips.new(0, o.position, { color: 0 }),
                          ))
                        : "end" == o &&
                          (d.push(
                              mp.blips.new(
            ...
            const C = setInterval(() => {
                ...
                if (r && !w) {
                    mp.objects.exists(m) &&
                        ...
                        g.forEach(
                            (o) =>
                                mp.objects.exists(o) && o.setCollision(!1, !0),
                        ),
                        mp.objects.exists(h) && h.destroy()
                    ...
                    if (o) {
                        ...
                        ;(t.z = mp.game.gameplay.getGroundZFor3dCoord(
                            ...
                            (h = mp.objects.new(
                                mp.game.joaat("ng_proc_box_02b"),
                                t,
                                {
                                    rotation: new mp.Vector3(
                                        0,
                                        0,
                                        o.getRotation(2).z + 180,
                                    ),
                                },
                            ))
                    }
                    ...
                    !r &&
                        ...
                        g.forEach(
                            (o) =>
                                mp.objects.exists(o) && o.setCollision(!0, !1),
                        ),
                        mp.objects.exists(h) && h.destroy(),
                        mp.attachmentMngr.addClient(
                            localPlayer,
